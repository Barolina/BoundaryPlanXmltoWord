...
# -*- coding: utf-8 -*-
#
# BNoL documentation build configuration file, created by
...
project = 'BNoL'
copyright = '2016, Arran Schlosberg'
...
latex_documents = [
    (master_doc, 'BNoL.tex', 'BNoL Documentation',
     'Arran Schlosberg', 'manual'),
]
...
man_pages = [
    (master_doc, 'bnol', 'BNoL Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'BNoL', 'BNoL Documentation',
     author, 'BNoL', 'One line description of project.',
     'Miscellaneous'),
]
